...
public class EventServiceImpl implements EventService {
    ...
    public List<EventShortDto> getEvents(EventSearchParams params, Integer from, Integer size) {
        ...
        if (params.getSort() != null) {
            ...
            switch (eventSort) {
                case EVENT_DATE -> eventShortDtos.sort((o1, o2) -> o2.getEventDate().compareTo(o1.getEventDate()));
                case VIEWS -> eventShortDtos.sort(Comparator.comparing(EventShortDto::getViews));
            }
        }
